...
def select_food(request):
    ...
    if request.method == "POST" and form_id1:
        ...
        if food:
            ...
            context = {"data": data, "form": form, "food_name": food_name, "food": food, "food_cal":food_cal,"food_pro":food_pro,"food_fat":food_fat,"food_carb":food_carb, 'finaldata':finaldata}
        ...
        try:
            f_name = globals()['food_item'][0]['DESC_KOR']
            f_cal = globals()['food_item'][0]['NUTR_CONT1']
            f_pro = globals()['food_item'][0]['NUTR_CONT3']
            f_fat = globals()['food_item'][0]['NUTR_CONT4']
            f_carb = globals()['food_item'][0]['NUTR_CONT2']
        except:
